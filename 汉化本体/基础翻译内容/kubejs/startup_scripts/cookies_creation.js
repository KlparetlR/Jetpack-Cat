...
onEvent('item.registry', event => {
	...
	}).displayName('稀有级枪箱').tooltip("吃掉这个箱子即可随机获得一把稀有级枪械！").glow(true)
})
...
onEvent('item.registry', event => {
	...
	}).displayName('超稀有级枪箱').tooltip("吃掉这个箱子即可随机获得一把超稀有级枪械！").glow(true)
})
...
onEvent('item.registry', event => {
	...
	}).displayName('珍奇级枪箱').tooltip("吃掉这个箱子即可随机获得一把珍奇级枪械！").glow(true)
})
